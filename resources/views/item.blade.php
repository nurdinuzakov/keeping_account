...
<div id="myModal" class="modal">
    <div class="modal-content">
        <div class="modal-header">
            <h2>Please enter new item</h2>
            <span class="close">&times;</span>
        </div>
        <div class="modal-body">
            <form action="{{ route('create-item', $id) }}" method="post">
                @csrf
...
<div class="card card-cascade narrower">
    ...
    <div
        ...
        <a href="" class="white-text mx-3">Items table</a>

        <div>
            <!-- Trigger/Open The Modal -->
            <button class="btn btn-primary" id="myBtn">Create item</button>
        </div>
    </div>
    <!--/Card image-->
